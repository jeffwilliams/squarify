...
const (
  // Lay out the row vertically
  Vertical direction = iota
  // Lay out the row horizontally
  Horizontal
)
...
// a slice of Blocks for rendering and a slice of Metas which contain metainformation corresponding
